...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		if (guess.equals("Magali")){
			 score+=1;
			 JOptionPane.showMessageDialog(null,"You are right " + score ); 
			
		}
		// -- Tell them they are wrong and who the person is
		else {JOptionPane.showMessageDialog(null,"You are wrong it is Magali" );
		...
		if (guess.equals("Dicaprio")){
			 score+=1;
			 JOptionPane.showMessageDialog(null,"You are right " + score );  
		}
			 else {JOptionPane.showMessageDialog(null,"You are wrong it is Dicaprio" );
