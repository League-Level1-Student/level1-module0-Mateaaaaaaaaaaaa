...
public class TooManyShapes {
	...
	public static void main(String[] args) {
		...
		String side=JOptionPane.showInputDialog(null,"How many sides do you want your shade to be?" );
		int sidesasint = Integer.parseInt(side);

		//2. Ask the user how many shapes they want
		String shape =JOptionPane.showInputDialog(null,"How many shapes do you want?" );
		int shapeasint = Integer.parseInt(shape);

		//3. Call canMakeShape() and save what is returned into a variable
		boolean shapePossible =canMakeShape(sidesasint);
		...
		if(shapePossible) {
			...
			int angle = calculateTurnAngle(sidesasint);
			//6. Use drawPolygons() to draw your shape
			drawPolygons (sidesasint,shapeasint,angle);
		}
